    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discontinious', models.CharField(choices=[('True', 'True'), ('False', 'False')], default=False, max_length=8)),
                ('discontinious_on', models.DateField()),
                ('assessment', multiselectfield.db.fields.MultiSelectField(choices=[('BT', 'BT'), ('OT', 'OT'), ('ST', 'ST')], max_length=2)),
                ('slot_time_from', models.TimeField()),
                ('slot_time_to', models.TimeField()),
                ('theropy', models.CharField(choices=[('BT', 'BT'), ('OT', 'OT'), ('ST', 'ST'), ('PT', 'PT'), ('SE', 'SE')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tests_administered', models.CharField(choices=[('DST', 'DST'), ('VSMS', 'VSMS'), ('MISIC', 'MISIC')], max_length=6)),
                ...
                ('modified_on', models.DateTimeField(blank=True, null=True)),
                ('modified_by', models.CharField(max_length=200)),
                ('email_sent', models.CharField(max_length=10)),
